...
do
		curl http://kvm-rn3stg-01.pdmz.eea:30741/v1/catalog/service/${services[$i]}| jq . > $tmp_fld/${services[$i]}.json 
		...
		while read p; do 
			#sleep 2
			echo "Removing $p from  http://kvm-rn3stg-01.pdmz.eea:30741 "
			curl -v -X PUT http://kvm-rn3stg-01.pdmz.eea:30741/v1/agent/service/deregister/$p
			#sleep 1
			#echo "Removing $p from the second endpoint http://10.50.4.185:32233 just for the fun of it !!!!"
			#curl -v -X PUT http://10.50.5.14:32233/v1/agent/service/deregister/$p
