...
def CopySecretFiles()
 {
					...
					withCredentials([file(credentialsId: 'application.properties', variable: 'FILE')]) {
						...
						// FOR EACH ENV WE NEED TO PUT THE NEW KEYCLOAK KEY TO THE BELOW BLOCK - WHENEVER THERE IS A NEW KEY !
						 def KC_OLD_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:"  //local variable
						 def DEV_KC_NEW_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:"  //local variable
						 def TEST_KC_NEW_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:" //local variable
						 def SANDBOX_KC_NEW_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:" //local variable
						 def PROD_KC_NEW_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:CHANGEME" //local variable
						 def PROD2_KC_NEW_PUB_KEY="KEYCLOAK_CLIENT_PUBLIC_KEY:CHANGEME" //local variable
						...
						RP3_TEST_DRM_CLI_URL="https://dremio-reportnet-pre01.eea.europa.eu:9047"
						 ...
						 sh """	case "${params.Env}" in
								...
								test ) 
									...
									;;
								sandbox )
									sed -i "s|${KC_OLD_PUB_KEY}|${SANDBOX_KC_NEW_PUB_KEY}|g" $WORKSPACE/helm/eaa-deploy/application-config/files/application.properties
