...
echo 'repmgr:md53bb517d7572053f9ec7f30dbc8a990f4' >> /opt/bitnami/pgpool/conf/pool_passwd && \
...
Array=($(kubectl --kubeconfig=$KC -n $NS get pods | grep kc-pgpool | awk -F " " '{print $1}'));
for str in ${Array[@]}
 do
  echo $str
